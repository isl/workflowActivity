...
public class FortressAdmObjects  implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
	 ...
	 private void workflowAdmobjs(WebDriver driver)
	 {
		 for(int i=0; i<10; i++){
