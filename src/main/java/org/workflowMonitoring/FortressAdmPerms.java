...
public class FortressAdmPerms  implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		Thread thread2 = new Thread(){
			public void run(){
		        ...
		        login(remoteDriver1);
		        TUtils.sleep( 1 );
		        workflowAdmperms(remoteDriver1);
		    	 /*****
		         *  LOGOUT
		         */
	  ...
	  private void workflowAdmperms(WebDriver driver)
	    {
		  for(int i=0; i<10;i++){
