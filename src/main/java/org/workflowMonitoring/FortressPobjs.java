...
public class FortressPobjs  implements JavaDelegate {
    ...
    private void workflowPobjs(WebDriver driver)
    {
    	for(int i=0; i<10; i++){
        driver.findElement( By.linkText( "POBJS" ) ).click();
        TUtils.sleep( 4 );
        driver.findElement( By.id( GlobalIds.SEARCH_VAL ) ).sendKeys( "Selecting the Pobjs Service " + i+1 );
