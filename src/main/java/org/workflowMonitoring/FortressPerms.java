...
public class FortressPerms  implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
	 ...
	 private void workflowPerms(WebDriver driver)
	    {
	    	for(int i=0; i<10; i++){
	        driver.findElement( By.linkText( "PERMS" ) ).click();
	        TUtils.sleep( 3 );
	        driver.findElement( By.id( "permObject" ) ).sendKeys( "/cal " + i+1 );
